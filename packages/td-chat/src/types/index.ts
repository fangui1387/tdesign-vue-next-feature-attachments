...
import { AvatarProps, TextareaProps, CollapsePanelProps } from 'tdesign-vue';

export type TNode<T = undefined> = T extends undefined
  ? (h: typeof import('vue').h) => import('vue').VNode
  : (h: typeof import('vue').h, props: T) => import('vue').VNode;
...
export interface TdChatMessageConfig {
  ...
  assistant?: Partial<TdChatItemProps> & {
    chatContentProps?: Partial<TdChatContentProps> & Record<string, any>;
  };
  [key: string]: any;
}
